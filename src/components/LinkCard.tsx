...
export function LinkCard({ linkCard }: LinkCardProps) {
  ...
  return (
    <div 
      onClick={handleClick}
      className="bg-gray-900 dark:bg-gray-800 rounded-xl overflow-hidden cursor-pointer hover:transform hover:scale-105 transition-all duration-200 group relative border border-gray-50 dark:border-gray-900"
    >
