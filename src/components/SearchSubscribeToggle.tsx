      ...
      <form onSubmit={handleSubmit}>
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`px-6 py-2 bg-blue-500 text-white rounded-lg font-medium hover:bg-blue-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 whitespace-nowrap flex-shrink-0 w-24 ${buttonClassName}`}
          >
