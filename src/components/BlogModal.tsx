...
export function BlogModal({
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-gray-800 rounded-none md:rounded-xl max-w-4xl w-full max-h-full md:max-h-[90vh] flex flex-col overflow-hidden outline-none relative" 
