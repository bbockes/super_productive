...
import { XIcon, ClockIcon, CopyIcon, CheckIcon, TwitterIcon, LinkedinIcon, FacebookIcon, MailIcon, MessageCircleIcon } from 'lucide-react';
              ...
              {post.id !== 'about' && post.id !== '404' && (
                <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex items-center gap-3 mb-4">
                    <img src="/giving_time.svg" alt="Giving time icon" className="w-5 h-5 text-gray-600 dark:text-gray-400" />
