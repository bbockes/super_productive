...
export function BlogModal({
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-gray-800 rounded-none md:rounded-xl max-w-4xl w-full h-full md:max-h-[calc(100vh-60px)] md:h-auto flex flex-col overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700 relative" 
