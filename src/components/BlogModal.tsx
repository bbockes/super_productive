...
export function BlogModal({
  ...
  return (
    <div 
      className="fixed inset-0 bg-white bg-opacity-70 dark:bg-black dark:bg-opacity-70 flex items-center justify-center md:p-4 z-50"
      onClick={onClose}
    >
      <div 
        className="bg-white dark:bg-gray-800 rounded-none md:rounded-xl max-w-4xl w-full h-full md:max-h-[90vh] md:h-auto flex flex-col overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700 relative" 
                ...
                <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex items-center gap-2 overflow-x-auto">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-white rounded-lg transition-colors whitespace-nowrap flex-shrink-0"
                    >
